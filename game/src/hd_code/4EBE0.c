 ...
 * display lists. The resulting world position is written to D_hd_code_803F7664/68/6C
...
extern f32 D_hd_code_8039CA10[4][4]; /* proposed: gSplineBasisMtx — cardinal-spline basis matrix */
extern s32 D_hd_code_803F7664; /* proposed: gMovedBuildingX — output world position, read back by the draw loop */
extern s32 D_hd_code_803F7668; /* proposed: gMovedBuildingY */
extern s32 D_hd_code_803F766C; /* proposed: gMovedBuildingZ */
...
extern f32 D_hd_code_8039CA50; /* proposed: gSplineT  — interpolation parameter t */
 ...
 * resulting world position to D_hd_code_803F7664/68/6C for the caller to store back.
...
void func_hd_code_802933A0(s32 arg0, s32 arg1, s32 arg2, s32 arg3, Mtx* arg4, s32 arg5, Gfx* arg6, Gfx* arg7, s32 arg8, s32 arg9, s32 arg10, s32 arg11) {
    ...
    guMtxF2L(sp78, arg4);
    D_hd_code_803F7664 = (spBE << 5) + arg0;
    D_hd_code_803F7668 = (spBC << 5) + arg1;
    D_hd_code_803F766C = (spBA << 5) + arg2;
...
void func_hd_code_802936AC(f32 (*arg0)[4], s16 arg1, s16 arg2, s16 arg3, s16 arg4, s16* arg5, s16* arg6, s16* arg7, struct S_802936AC* arg8, s32 arg9) {
    ...
    sp54 = 0;
    sp53 = 0;
    if ((D_hd_code_8036E4C8 == 0) && (D_hd_code_8036DCD8.link.next != NULL)) {
        sndDeactivate(D_hd_code_8036DCD8.link.next);
    }
    if (D_hd_code_802E8BD0 == 0) {
        if (D_hd_code_8036E4CA != 0) {
            arg8->unk8 = -1;
    ...
    if ((D_hd_code_8036E4C8 == 0) || ((D_hd_code_803156C4 & 0xF) >= 7U)) {
...
void func_hd_code_80293F84(f32 (*arg0)[4], s16 arg1, s16 arg2, s16* arg3, s16* arg4, s16* arg5, struct S_802936AC* arg6, s32 arg7) {
    ...
    D_hd_code_8039CA50 = ((f32) arg6->unk4 / 1000.0);
    D_hd_code_8039CA54 = D_hd_code_8039CA50 * D_hd_code_8039CA50;
    D_hd_code_8039CA58 = D_hd_code_8039CA54 * D_hd_code_8039CA50;
 ...
 * parameter whose powers were precomputed in D_hd_code_8039CA50/54/58 (t, t^2, t^3),
 * using the basis matrix D_hd_code_8039CA10 set up by func_hd_code_802949B0:
...
f32 func_hd_code_80294840(f32 arg0, f32 arg1, f32 arg2, f32 arg3) {
  ...
  spC = D_hd_code_8039CA10[0][0] * arg0 + D_hd_code_8039CA10[1][0] * arg1 + D_hd_code_8039CA10[2][0] * arg2 + D_hd_code_8039CA10[3][0] * arg3;
  sp8 = D_hd_code_8039CA10[0][1] * arg0 + D_hd_code_8039CA10[1][1] * arg1 + D_hd_code_8039CA10[2][1] * arg2 + D_hd_code_8039CA10[3][1] * arg3;
  sp4 = D_hd_code_8039CA10[0][2] * arg0 + D_hd_code_8039CA10[1][2] * arg1 + D_hd_code_8039CA10[2][2] * arg2 + D_hd_code_8039CA10[3][2] * arg3;
  sp0 = D_hd_code_8039CA10[0][3] * arg0 + D_hd_code_8039CA10[1][3] * arg1 + D_hd_code_8039CA10[2][3] * arg2 + D_hd_code_8039CA10[3][3] * arg3;

  return spC * D_hd_code_8039CA58 + D_hd_code_8039CA54 * sp8 + D_hd_code_8039CA50 * sp4 + sp0;
}

/* Proposed name: InitCardinalSplineBasis
 * Fills D_hd_code_8039CA10 with the cardinal-spline basis matrix for path arg0,
...
void func_hd_code_802949B0(s32 arg0) {
  ...
  D_hd_code_8039CA10[0][0] = -sp4;
  D_hd_code_8039CA10[0][1] = sp4 * 2.0;
  D_hd_code_8039CA10[0][2] = -sp4;
  D_hd_code_8039CA10[0][3] = 0.0f;
  D_hd_code_8039CA10[1][0] = 2.0 - sp4;
  D_hd_code_8039CA10[1][1] = sp4 - 3.0;
  D_hd_code_8039CA10[1][2] = 0.0f;
  D_hd_code_8039CA10[1][3] = 1.0f;
  D_hd_code_8039CA10[2][0] = sp4 - 2.0;
  D_hd_code_8039CA10[2][1] = 3.0 - sp4 * 2.0;
  D_hd_code_8039CA10[2][2] = sp4;
  D_hd_code_8039CA10[2][3] = 0.0f;
  D_hd_code_8039CA10[3][0] = sp4;
  D_hd_code_8039CA10[3][1] = -sp4;
  D_hd_code_8039CA10[3][2] = 0.0f;
  D_hd_code_8039CA10[3][3] = 0.0f;
}
