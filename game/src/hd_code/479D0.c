...
// ammo/charge counter (D_hd_code_803F8B72 or D_hd_code_803EDC00, the counters shown by the
...
// D_hd_code_802FDB40 template table; live crates live in D_hd_code_8039AF00.
...
void LoadLevelAmmo(struct S_AmmoData* arg0, s32 arg1) {
  D_hd_code_8039B068 = 0;
  while ((s32)arg0 != arg1) {
    D_hd_code_8039AF00[D_hd_code_8039B068].unk0 = arg0->unk0;
    D_hd_code_8039AF00[D_hd_code_8039B068].unk2 = arg0->unk2;
    D_hd_code_8039AF00[D_hd_code_8039B068].unk4 = arg0->unk4;
    D_hd_code_8039AF00[D_hd_code_8039B068].unk6 = arg0->unk6;
    D_hd_code_8039AF00[D_hd_code_8039B068].unk7 = 0;
    ...
    func_hd_code_8028C41C(D_hd_code_8039AF00[D_hd_code_8039B068].unk14,
                          ...
                          D_hd_code_8039AF00[D_hd_code_8039B068].unk2,
                          (s32) D_hd_code_8039AF00[D_hd_code_8039B068].unk4);
    D_hd_code_8039B068 += 1;
    arg0++;
  }
}
...
void func_hd_code_8028C874(u8 arg0) {
  ...
  for(i = 0; i < D_hd_code_8039B068; i++) {
    if ((u8) D_hd_code_8039AF00[i].unk7 == 0) {
      if (D_hd_code_802FDB40[D_hd_code_8039AF00[i].unk6].unk14 == arg0) {
        ...
        distance = func_hd_code_8026A6F0(
            ...
            (s32) D_hd_code_8039AF00[i].unk0,
            (s32) D_hd_code_8039AF00[i].unk2,
            (s32) D_hd_code_8039AF00[i].unk4);

        if (distance <= D_hd_code_802FDB40[D_hd_code_8039AF00[i].unk6].unk12) {
          D_hd_code_8039AF00[i].unk7 = 1;
          sndPlaySfx(D_hd_code_80367738, 0x70, NULL);
          switch (D_hd_code_8039AF00[i].unk6) {
            case 0:
              D_hd_code_803F8B72 += 10;
              break;
            case 1:
              D_hd_code_803EDC00 += 10;
              break;
          }
        }
      } else {
        func_hd_code_802CE880(i + 0x10000,
                              D_hd_code_8039AF00[i].unk0 << 5,
                              D_hd_code_8039AF00[i].unk2 << 5,
                              D_hd_code_8039AF00[i].unk4 << 5,
                              D_hd_code_802FDB40[D_hd_code_8039AF00[i].unk6].unk10);
      }
    } else {
      D_hd_code_8039AF00[i].unk8 -= 20;
      if (D_hd_code_8039AF00[i].unk8 < 0) {
        D_hd_code_8039AF00[i].unk8 = 0;
      }
    }
  }
}
...
void func_hd_code_8028CB30(Gfx** gfx, s32* arg1) {
    ...
    for(spE0 = 0; spE0 < D_hd_code_8039B068; spE0++) {
        if (((u8) D_hd_code_8039AF00[spE0].unk7 == 0) || (D_hd_code_8039AF00[spE0].unk8 != 0)) {
            gDPPipeSync(entry++);

            if ((D_hd_code_8039AF00[spE0].unk7 == 0) && ((spDF == 0) || (spDF == 2))) {
                gDPSetRenderMode(entry++, G_RM_AA_ZB_OPA_SURF, G_RM_AA_ZB_OPA_SURF2);
                spDF = 1;
            }
            if ((D_hd_code_8039AF00[spE0].unk7 != 0) && ((spDF == 0) || (spDF == 1))) {
                gDPSetRenderMode(entry++, G_RM_AA_ZB_XLU_SURF, G_RM_AA_ZB_XLU_SURF2);
                spDF = 2;
            }
            gDPSetPrimColor(entry++, 0, 0, 0, 0, 0, D_hd_code_8039AF00[spE0].unk8);

            gSPVertex(entry++, osVirtualToPhysical(D_hd_code_8039AF00[spE0].unk14), 8, 0);

            gDPSetTextureImage(entry++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, OS_PHYSICAL_TO_K0(D_hd_code_8039AF00[spE0].unkC));
            ...
            gDPLoadTextureBlock(entry++, OS_PHYSICAL_TO_K0(D_hd_code_8039AF00[spE0].unk10), G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
