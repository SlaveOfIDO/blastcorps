...
// (D_hd_code_8036C8D0, head/tail D_hd_code_8036CB29/28, entries expire after 1000 frames);
...
// a new one when the vehicle code flagged it (D_hd_code_8036CB2F, with metrics in
// D_hd_code_8036CB2A/2C/2E), retally and run the praise/criticism checks; at frame
// 50 play the mission-start advisor clip; and in carrier levels fire the
// scripted one-shot comms from the level data (D_hd_code_803BE6FC list) as the
...
void func_hd_code_80277620(s32 arg0) {
    ...
    sp2F = 0;
    sp28 = D_hd_code_803BE6FC;
    while ((sp2F == 0) && ((u8) D_hd_code_8036CB28 != (u8) D_hd_code_8036CB29)) {
        if ((arg0 - D_hd_code_8036C8D0[D_hd_code_8036CB28].unk8) >= 0x3E9) {
            D_hd_code_8036CB28++;
            if (D_hd_code_8036CB28 == 0x32) {
    ...
    if ((D_hd_code_8036CB2F != 0) && (((u8) D_hd_code_8036CB29 + 1) != (u8) D_hd_code_8036CB28) && (((u8) D_hd_code_8036CB29 != 0x31) || ((u8) D_hd_code_8036CB28 != 0))) {
        D_hd_code_8036C8D0[D_hd_code_8036CB29].unk0 = func_hd_code_80277D34();
        D_hd_code_8036C8D0[D_hd_code_8036CB29].unk2 = func_hd_code_80277E08();
        D_hd_code_8036C8D0[D_hd_code_8036CB29].unk4 = D_hd_code_8036CB2E;
        D_hd_code_8036C8D0[D_hd_code_8036CB29].unk8 = arg0;

        D_hd_code_8036CB29++;
        if (D_hd_code_8036CB29 == 0x32) {
            D_hd_code_8036CB29 = 0;
        }
    }
    if (D_hd_code_8036CB2F != 0) {
    ...
    if (D_hd_code_803643DB != 0) {
        sp26 = (s16) ((s32) D_hd_code_803EF6E4 >> 5);
        while ((u32)sp28 < (u32) D_hd_code_803BE700) {
...
void func_hd_code_802778FC(void) {
  switch (D_hd_code_80364456) {                   /* irregular */
    case 5:
      if (((s32) D_hd_code_8036CB31 >= 0x10) && ((s32) D_hd_code_8036CB30 >= 0x10)) {
      ...
      return;
    case 4:
      if (((s32) D_hd_code_8036CB31 >= 0x29) && ((s32) D_hd_code_8036CB30 >= 0x29)) {
      ...
      break;
    case 3:
      if (((s32) D_hd_code_8036CB31 >= 0xB) && ((s32) D_hd_code_8036CB30 >= 0xB)) {
      ...
      break;
    case 9:
      if (((s32) D_hd_code_8036CB31 >= 0x1A) && ((s32) D_hd_code_8036CB30 >= 0x1A)) {
        func_hd_code_80277EDC(4, 1, 1, func_hd_code_8026205C(4));
        D_hd_code_8036CB28 = 0;
        D_hd_code_8036CB29 = 0;
        rmonPrintf("DOING REALLY WELL\n");
...
void func_hd_code_80277AE0(void) {
  switch(D_hd_code_80364456) {
    ...
    case 5:
    case 9:
      if (((s32) D_hd_code_8036CB31 >= 6) && ((s32) D_hd_code_8036CB30 < 2)) {
...
void func_hd_code_80277B84(void) {
  switch(D_hd_code_80364456) {
    ...
    case 4:
    case 5:
      if (((s32) D_hd_code_8036CB33 >= 0x1F) && ((s32) D_hd_code_8036CB30 < 6)) {
...
// Recompute the good/bad sample tallies (D_hd_code_8036CB30..33) from the ring
// Proposed name: TallySkillSamples
void func_hd_code_80277C20(void) {
  u8 sp7 = D_hd_code_8036CB28;

  D_hd_code_8036CB30 = 0;
  D_hd_code_8036CB31 = 0;
  D_hd_code_8036CB32 = 0;
  D_hd_code_8036CB33 = 0;

  while (sp7 != D_hd_code_8036CB29) {
    if (D_hd_code_8036C8D0[sp7].unk2 == 0) {
      D_hd_code_8036CB30 += 1;
    } else {
      D_hd_code_8036CB32 += 1;
    }
    if (D_hd_code_8036C8D0[sp7].unk0 == 0) {
      D_hd_code_8036CB31 += 1;
    } else {
      D_hd_code_8036CB33 += 1;
    }
    sp7++;
    if (sp7 == 0x32) {
      sp7 = 0;
...
s16 func_hd_code_80277D34(void) {
  switch (D_hd_code_8036CB2E) {                           /* irregular */
    case 5:
      if (D_hd_code_8036CB2A >= 0x191) {
        return 0;
      }
      return 1;
    case 4:
...
void func_hd_code_80277EDC(u8 arg0, u8 arg1, s32 arg2, s32 arg3) {
    ...
    if (((D_hd_code_80364A90 & 0x200000000400220C)) && ((u8) D_hd_code_8036CB34 == 0)) {
        ...
        D_hd_code_8036CB34 = 1;
        D_hd_code_8036CB35 = arg2;
        D_hd_code_8036CB36 = 0;
        D_hd_code_8036CB37 = 0;
        D_hd_code_8036CB39 = 0;
        D_hd_code_8036CB3A = 0;
        D_hd_code_8036CB38 = (u8) arg1;
        D_hd_code_8036CB44 = (u8) arg0;
        D_hd_code_8036CB50 = 0;
        switch (arg0) {                        /* switch 1 */
        case 0:                                     /* switch 1 */
            sp27 = 0;
            D_hd_code_8036CB3C = 0xD;
            D_hd_code_8036CB40 = D_hd_code_802FBDD0;
            D_hd_code_8036CB3B = 1;
            break;
        case 1:                                     /* switch 1 */
            sp27 = 1;
            D_hd_code_8036CB3C = 0x15;
            D_hd_code_8036CB40 = D_hd_code_802FBDEC;
            D_hd_code_8036CB3B = 1;
            break;
        case 2:                                     /* switch 1 */
            sp27 = 0;
            D_hd_code_8036CB3C = 0x15;
            D_hd_code_8036CB40 = D_hd_code_802FBE18;
            D_hd_code_8036CB3B = 2;
            break;
        case 3:                                     /* switch 1 */
            sp27 = 1;
            D_hd_code_8036CB3C = 0x1E;
            D_hd_code_8036CB40 = D_hd_code_802FBE44;
            D_hd_code_8036CB3B = 1;
            break;
        case 4:                                     /* switch 1 */
            sp27 = 0;
            D_hd_code_8036CB3C = 0x22;
            D_hd_code_8036CB40 = D_hd_code_802FBE80;
            D_hd_code_8036CB3B = 1;
            break;
        }
...
void func_hd_code_80278324(Gfx** arg0, s32* arg1, u8 arg2) {
    ...
    entry = *arg0;
    if (D_hd_code_8036CB34 != 0) {
        func_hd_code_802A1040((u16) D_hd_code_8036CB40->v.ob[D_hd_code_8036CB39], D_hd_code_8036CB48[arg2], 0);
        switch (D_hd_code_8036CB38) {
            case 1:
                if (D_hd_code_8036CB37 == 0) {
                    D_hd_code_8036CB3A++;
                    if (D_hd_code_8036CB3A == D_hd_code_8036CB3B) {
                        D_hd_code_8036CB3A = 0;
                        D_hd_code_8036CB39++;
                        if ((D_hd_code_8036CB39 + 1) == D_hd_code_8036CB3C) {
                            D_hd_code_8036CB37 = 1;
                            D_hd_code_8036CB36++;
                        }
                    }
                } else {
            ...
            case 0:
                ...
                if (D_hd_code_8036CB3A == D_hd_code_8036CB3B) {
                    D_hd_code_8036CB3A = 0;
                    D_hd_code_8036CB39++;
                    if (D_hd_code_8036CB39 == D_hd_code_8036CB3C) {
                        D_hd_code_8036CB39 = 0;
                        D_hd_code_8036CB36++;
                    }
                }
        ...
        if (D_hd_code_8036CB36 == D_hd_code_8036CB35) {
            D_hd_code_8036CB34 = 0;
        }
        if ((D_hd_code_8036CB36 == 0) && (D_hd_code_8036CB39 < 5)) {
            if (D_hd_code_8036CB39 == 0) {
                sndPlaySfx(D_hd_code_80367738, 0x69, NULL);
            }
            D_hd_code_8036CB51 = 0x50;
        } else if (D_hd_code_8036CB50 != 0) {
            D_hd_code_8036CB51 -= 0xF;
            D_hd_code_8036CB50--;
        } else if (func_hd_code_8026A828(0, 0x14) == 0) {
            D_hd_code_8036CB50 = 5;
            D_hd_code_8036CB51 = 0x50;
            sndPlaySfx(D_hd_code_80367738, 0x69, NULL);
        } else {
        ...
        gDPSetPrimColor(entry++, 0, 0, 0, 0, 0, D_hd_code_8036CB51);
        gDPLoadTextureBlock(entry++, OS_PHYSICAL_TO_K0(D_hd_code_8036CB48[arg2]), G_IM_FMT_RGBA, G_IM_SIZ_16b, 40, 40, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
