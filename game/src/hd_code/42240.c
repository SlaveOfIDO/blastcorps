...
// vehicle 3 (the Skyfall - the dial shows D_hd_code_803EE3B1 as a percentage), and
// two icon + numeric-counter widgets for vehicles 0xA and 1. The current
// vehicle id is passed in as arg3.

extern u8 D_hd_code_803EE3B1;
extern u8 *D_hd_code_8036EC00; // Texture
extern Vtx* D_hd_code_8036EC04;
extern Mtx* D_hd_code_8036EC08;
extern Mtx* D_hd_code_8036EC0C;
extern s16 D_hd_code_8036EC10;
extern u8* D_hd_code_8036EC14;
extern Vtx* D_hd_code_8036EC18;
extern s16 D_hd_code_8036EC1C;
extern u8* D_hd_code_8036EC20;
...
void func_hd_code_80286A00(void) {
  ...
  D_hd_code_8036EC04[0].v.tc[0] = 0;
  D_hd_code_8036EC04[0].v.tc[1] = 0x4E0;

  D_hd_code_8036EC04[1].v.ob[0] = 0x4D;
  D_hd_code_8036EC04[1].v.ob[1] = 0x7B;
  D_hd_code_8036EC04[1].v.ob[2] = -5;
  D_hd_code_8036EC04[1].v.tc[0] = 0x4E0;
  D_hd_code_8036EC04[1].v.tc[1] = 0x4E0;

  D_hd_code_8036EC04[2].v.ob[0] = 0x4D;
  D_hd_code_8036EC04[2].v.ob[1] = 0xAD;
  D_hd_code_8036EC04[2].v.ob[2] = -5;
  D_hd_code_8036EC04[2].v.tc[0] = 0x4E0;
  D_hd_code_8036EC04[2].v.tc[1] = 0;

  D_hd_code_8036EC04[3].v.ob[0] = 0x26;
  D_hd_code_8036EC04[3].v.ob[1] = 0xAD;
  D_hd_code_8036EC04[3].v.ob[2] = -5;
  D_hd_code_8036EC04[3].v.tc[0] = 0;
  D_hd_code_8036EC04[3].v.tc[1] = 0;

  D_hd_code_8036EC04[4].v.ob[0] = -1;
  D_hd_code_8036EC04[4].v.ob[1] = 0;
  D_hd_code_8036EC04[4].v.ob[2] = -5;

  D_hd_code_8036EC04[5].v.ob[0] = 1;
  D_hd_code_8036EC04[5].v.ob[1] = 0;
  D_hd_code_8036EC04[5].v.ob[2] = -5;

  D_hd_code_8036EC04[6].v.ob[0] = -1;
  D_hd_code_8036EC04[6].v.ob[1] = -17;
  D_hd_code_8036EC04[6].v.ob[2] = -5;

  D_hd_code_8036EC04[7].v.ob[0] = 1;
  D_hd_code_8036EC04[7].v.ob[1] = -17;
  D_hd_code_8036EC04[7].v.ob[2] = -5;

  D_hd_code_8036EC10 = 0;
}

// Draw the dial gauge (visible only in vehicle 3, fading in/out): the
// textured face, then the needle rotated to (D_hd_code_803EE3B1/100 * 180 + 270)
// degrees
// Proposed name: DrawDialGauge
void func_hd_code_80286C60(Gfx** gfx, s32* arg1, u8 arg2, u8 arg3) {
    Gfx* entry = *gfx;

    if (arg3 != 3 && D_hd_code_8036EC10 == 0) {
        return;
    }

    if (arg3 == 3 && D_hd_code_8036EC10 < 0xFF) {
        D_hd_code_8036EC10 += 0xA;
        if (D_hd_code_8036EC10 > 0xFF) {
            D_hd_code_8036EC10 = 0xFF;
        }
    }

    if (arg3 != 3 && D_hd_code_8036EC10 != 0) {
        D_hd_code_8036EC10 -= 0xA;
        if (D_hd_code_8036EC10 < 0) {
            D_hd_code_8036EC10 = 0;
        }
    }
...
void func_hd_code_802873AC(void) {
  ...
  D_hd_code_8036EC18[0].v.ob[2] = -5;
  D_hd_code_8036EC18[0].v.tc[0] = 0;
  D_hd_code_8036EC18[0].v.tc[1] = 0x3E0;

  D_hd_code_8036EC18[1].v.ob[0] = 0x40;
  D_hd_code_8036EC18[1].v.ob[1] = 0x87;
  D_hd_code_8036EC18[1].v.ob[2] = -5;
  D_hd_code_8036EC18[1].v.tc[0] = 0x3E0;
  D_hd_code_8036EC18[1].v.tc[1] = 0x3E0;

  D_hd_code_8036EC18[2].v.ob[0] = 0x40;
  D_hd_code_8036EC18[2].v.ob[1] = 0xA5;
  D_hd_code_8036EC18[2].v.ob[2] = -5;
  D_hd_code_8036EC18[2].v.tc[0] = 0x3E0;
  D_hd_code_8036EC18[2].v.tc[1] = 0;

  D_hd_code_8036EC18[3].v.ob[0] = 0x22;
  D_hd_code_8036EC18[3].v.ob[1] = 0xA5;
  D_hd_code_8036EC18[3].v.ob[2] = -5;
  D_hd_code_8036EC18[3].v.tc[0] = 0;
  D_hd_code_8036EC18[3].v.tc[1] = 0;
...
void func_hd_code_80287530(Gfx** gfx, struct Model1* arg1, u8 arg2, u8 arg3) {
  ...
  if (arg3 != 0xA && D_hd_code_8036EC1C == 0) {
    return;
  }

  if ((arg3 == 0xA) && (D_hd_code_8036EC1C < 0xFF)) {
    D_hd_code_8036EC1C += 0xA;
    if (D_hd_code_8036EC1C >= 0x100) {
      D_hd_code_8036EC1C = 0xFF;
    }
  }
  if ((arg3 != 0xA) && (D_hd_code_8036EC1C != 0)) {
    D_hd_code_8036EC1C -= 0xA;
    if (D_hd_code_8036EC1C < 0) {
      D_hd_code_8036EC1C = 0;
    }
  }
  ...
  func_hd_code_8026A378(D_hd_code_803F8B72, spB8);
  func_hd_code_80259DC8(arg1, (s32) &spB8, 0, 1, 0, 0x40, 0x91, 0xF, 0xF, 1, 0xFF, 0xFF, 0, MIN(D_hd_code_8036EC1C, D_hd_code_80367BD6), 0xFF, 0, 0, MIN(D_hd_code_8036EC1C, D_hd_code_80367BD6));
  gDPPipeSync(entry++);
...
void func_hd_code_80287AE4(void) {
  ...
  D_hd_code_8036EC24[0].v.ob[2] = -5;
  D_hd_code_8036EC24[0].v.tc[0] = 0;
  D_hd_code_8036EC24[0].v.tc[1] = 0x3E0;

  D_hd_code_8036EC24[1].v.ob[0] = 0x40;
  D_hd_code_8036EC24[1].v.ob[1] = 0x91;
  D_hd_code_8036EC24[1].v.ob[2] = -5;
  D_hd_code_8036EC24[1].v.tc[0] = 0x3E0;
  D_hd_code_8036EC24[1].v.tc[1] = 0x3E0;

  D_hd_code_8036EC24[2].v.ob[0] = 0x40;
  D_hd_code_8036EC24[2].v.ob[1] = 0xAF;
  D_hd_code_8036EC24[2].v.ob[2] = -5;
  D_hd_code_8036EC24[2].v.tc[0] = 0x3E0;
  D_hd_code_8036EC24[2].v.tc[1] = 0;

  D_hd_code_8036EC24[3].v.ob[0] = 0x22;
  D_hd_code_8036EC24[3].v.ob[1] = 0xAF;
  D_hd_code_8036EC24[3].v.ob[2] = -5;
  D_hd_code_8036EC24[3].v.tc[0] = 0;
  D_hd_code_8036EC24[3].v.tc[1] = 0;
...
void func_hd_code_80287C68(Gfx** gfx, struct Model1* arg1, u8 arg2, u8 arg3) {
  ...
  if (arg3 != 1 && D_hd_code_8036EC28 == 0) {
    return;
  }

  if ((arg3 == 1) && (D_hd_code_8036EC28 < 0xFF)) {
    D_hd_code_8036EC28 += 0xA;
    if (D_hd_code_8036EC28 >= 0x100) {
      D_hd_code_8036EC28 = 0xFF;
    }
  }
  if ((arg3 != 1) && (D_hd_code_8036EC28 != 0)) {
    D_hd_code_8036EC28 -= 0xA;
    if (D_hd_code_8036EC28 < 0) {
      D_hd_code_8036EC28 = 0;
    }
  }
  gSPMatrix(entry++, (u32) &D_2000000.mtx1, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_PROJECTION);
  ...
  func_hd_code_8026A378((s32) D_hd_code_803EDC00, spB8);
  func_hd_code_80259DC8(arg1, (s32) &spB8, 0, 1, 0, 0x44, 0x97, 0xF, 0xF, 1, 0xFF, 0xFF, 0, MIN(D_hd_code_8036EC28, D_hd_code_80367BD6), 0xFF, 0, 0, MIN(D_hd_code_8036EC28, D_hd_code_80367BD6));
  gDPPipeSync(entry++);
