...
UnknownData802081C0 D_hd_front_end_802081C0[31] = {
  { "ROOKIE WRECKER", D_hd_code_803041DC },
  { "TRAINED CRUSHER", D_hd_code_803041EC },
  { "EXPERIENCED RAVAGER", D_hd_code_803041FC },
  { "DECORATED DAMAGER", D_hd_code_8030420C },
  { "PROFESSIONAL RAZER", D_hd_code_8030421C },
  { "EXPERT DESTROYER", D_hd_code_8030422C },
  { "GIFTED RUINER", D_hd_code_8030423C },
  { "ACCOMPLISHED CONQUEROR", D_hd_code_8030424C },
  { "MASTER DESPOILER", D_hd_code_8030425C },
  { "DEMOLITION FANATIC", D_hd_code_8030426C },
  { "GRAND ERADICATOR", D_hd_code_8030427C },
  { "HEAVY DUTY WASTER", D_hd_code_80304288 },
  { "TOTAL PULVERISER", D_hd_code_8030429C },
  { "CHAMPION RANSACKER", D_hd_code_803042AC },
  { "MECHANICAL MAESTRO", D_hd_code_803042B8 },
  { "CHIEF OBLITERATOR", D_hd_code_803042CC },
  { "COMMANDING DESOLATOR", D_hd_code_803042E0 },
  { "SUPREME DEVASTATOR", D_hd_code_803042F0 },
  { "ULTIMATE ANNIHILATOR", D_hd_code_80304304 },
  { "LEVELING LEGEND", D_hd_code_8030430C },
  { "DESTRUCTIVE PSYCHOPATH", D_hd_code_80304318 },
  { "MINDLESS DESECRATOR", D_hd_code_80304328 },
  { "HYSTERICAL CLAUSTROPHOBE", D_hd_code_80304334 },
  { "UNCONTROLLABLE MADMAN", D_hd_code_80304344 },
  { "WORLD CLASS MEGALOMANIAC", D_hd_code_80304358 },
  { "CAPTAIN OF CARNAGE", D_hd_code_80304364 },
  { "SINGLE MINDED CHAOSMONGER", D_hd_code_80304370 },
  { "GRAND HIGH SLAUGHTERMASTER", D_hd_code_8030437C },
  { "LUNATIC LORD OF HAVOC", D_hd_code_80304388 },
  { "ARMAGEDDON ADEPT", D_hd_code_80304394 },
  { "YOU CAN STOP NOW.", D_hd_code_8030439C }
};
...
void func_hd_front_end_801E8EB8(u8 arg0, s32 arg1) {
    ...
    if (!(g_currentGameState & 0x10E18000) && (arg0 != D_hd_code_80364AEA)) {
        sp47 = 1;
    }
...
Gfx *func_hd_front_end_801EAA7C(Gfx *gfx, struct Model1 *arg1, s32 *arg2) {
    ...
    if ((g_currentButtons & (L_JPAD | R_JPAD)) && !(g_previousButtons & (L_JPAD | R_JPAD))) {
    ...
    if (D_hd_front_end_802154B6 != D_hd_front_end_802154B8) {
        sndPlaySfx(D_hd_code_80367738, 0x90, NULL);
    }
    D_hd_front_end_802154B8 = D_hd_front_end_802154B6;
    ...
    if ((D_hd_code_8036BB1C == 2) && (g_currentButtons & START_BUTTON) && !(g_previousButtons & START_BUTTON) && (areWeFading() == 0)) {
    ...
    case 0:
        if ((D_hd_code_8036BB1C == 2) && (g_currentButtons & (A_BUTTON | B_BUTTON)) && !(g_previousButtons & (A_BUTTON | B_BUTTON)) && (areWeFading() == 0)) {
            if (g_currentButtons & B_BUTTON) {
                spF7 = 0x7F;
            }
            if (spF7 == 0x7F) {
                if (D_hd_front_end_802154BC == 0) {
                    ...
                    sndPlaySfx(D_hd_code_80367738, 0xE4, NULL);
    ...
    case 1:
        ...
        if ((ABS((D_hd_front_end_80215944 - D_hd_front_end_8021594C))) < 0.15
            ...
            sndPlaySfx(D_hd_code_80367738, 1, NULL);
            D_hd_front_end_802154BE = 0,
            D_hd_front_end_802154C0 = 0;
    ...
    case 0:
      ...
      if (D_hd_front_end_80215908[arg3] == 0) {
        ...
        if ((u8) D_hd_front_end_80215902[arg3] == 5) {
          sndPlaySfx(D_hd_code_80367738, 0xEA, NULL);
        } else {
          sndPlaySfx(D_hd_code_80367738, 0xE6, NULL);
        }
      }
      break;
    case 4:
