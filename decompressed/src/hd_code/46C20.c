...
void InitiateDma(u8* arg0, u8* arg1, s32* arg2, u8 arg3, u8 arg4, u8 arg5) {
  ...
  for(sp44 = 0; sp44 < (u32) ((u32) *arg2 >> 0xE); sp44++) {
    osPiStartDma(&D_hd_code_80370C58, 0, OS_READ, (u32) arg0, sp34, 0x4000U, &D_hd_code_803150A0);
  ...
  if (sp40 != 0) {
    osPiStartDma(&D_hd_code_80370C58, 0, OS_READ, (u32) arg0, sp34, sp40, &D_hd_code_803150A0);
    osRecvMesg(&D_hd_code_803150A0, NULL, 1);
  }
