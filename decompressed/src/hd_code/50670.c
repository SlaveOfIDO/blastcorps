...
// (D_hd_code_8039CA68[1]); if the run beats the saved best time it is copied to the
// ghost buffer (D_hd_code_8039CA68[0]) at 0x80055400. On later runs the ghost is
...
extern s32 D_hd_code_8039CA78;
extern s32 D_hd_code_8039CA84;
extern u8 D_hd_code_8039CA7C;
extern void* D_hd_code_803BDB00;
extern void* D_hd_code_803BDB04;
extern void* D_hd_code_803BDB08;
extern u8 D_hd_code_8039CA7D;
extern u32 D_hd_code_8039CA88;
extern u8 D_hd_code_8039CA7D;
extern s32 D_hd_code_8039CA70[2];
extern s32 D_hd_code_8039CA80;
extern u8 D_hd_code_8039CA8C;
extern s32 D_hd_code_8039CA78;
extern u8 D_hd_code_8039CA7C;
extern u8 D_hd_code_8039CA7D;
extern u8 D_hd_code_8039CA7E;
extern s32 D_hd_code_8039CA84;
extern struct S_8039CA68* D_hd_code_8039CA68[2];
extern s32 D_hd_code_8039CA80;
extern s16 D_hd_code_803ED390[3];
...
void func_hd_code_80294E30(void) {
  D_hd_code_8039CA68[0] = (struct S_8039CA68*)0x80055400;
  D_hd_code_8039CA68[1] = (struct S_8039CA68*)0x80065400;
  D_hd_code_8039CA88 = func_hd_code_80286038(0xFFFF) - 1;
  D_hd_code_8039CA7D = 0;
}
...
void func_hd_code_80294E88(void) {
  D_hd_code_8039CA70[1] = 0;
  D_hd_code_8039CA80 = -1;
  D_hd_code_8039CA62 = 1;
  D_hd_code_8039CA8C = 0;
}
...
void func_hd_code_80294EB8(void) {
  if (D_hd_code_8039CA7D != 0) {
    D_hd_code_8039CA61 = 1;
    D_hd_code_8039CA84 = -1;
    D_hd_code_8039CA78 = 0;
    D_hd_code_8039CA7E = D_hd_code_8039CA7C;
  }
}
...
void func_hd_code_80294F00(void) {
  if (D_hd_code_80364A90 & 0x104) {
    ...
    if ((u32) D_hd_code_8039CA70[1] < 0xCCCU) {
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unk0 = D_hd_code_803643E0;
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unk4 = D_hd_code_803643E4;
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unk8 = D_hd_code_803643E8;
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unkC = D_hd_code_803ED390[0];
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unkE = D_hd_code_803ED390[1];
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unk10 = D_hd_code_803ED390[2];
      D_hd_code_8039CA68[1][D_hd_code_8039CA70[1]].unk12 = (D_hd_code_803156C0 - D_hd_code_8039CA80);
      D_hd_code_8039CA70[1]++;
      return;
    }
    D_hd_code_8039CA8C = 1;
...
void func_hd_code_80295120(Gfx** gfx, struct Model1* arg1) {
  ...
  if (D_hd_code_8039CA61 != 0) {
    func_hd_code_80295394(&sp60, &sp5C, &sp58, &sp56, &sp54, &sp52);
    func_hd_code_802AA6D0(sp60, sp5C, sp58, sp56, (s32) sp54, (s32) sp52, D_hd_code_802FF0D0[D_hd_code_8039CA7C], &arg1->unk14C0);

    gSPSegment(entry++, 0x06, osVirtualToPhysical(D_hd_code_803BDB04));
    gSPSegment(entry++, 0x07, osVirtualToPhysical(D_hd_code_803BDB00));
    ...
    gSPDisplayList(entry++, osVirtualToPhysical(D_hd_code_803BDB08));
...
void func_hd_code_80295394(s32* arg0, s32* arg1, s32* arg2, s16* arg3, s16* arg4, s16* arg5) {
    ...
    if (D_hd_code_80364A90 == 0x2000) {
        ...
        *arg3 = D_hd_code_8039CA68[0][0].unkC;
        *arg4 = D_hd_code_8039CA68[0][0].unkE;
        *arg5 = D_hd_code_8039CA68[0][0].unk10;
        D_hd_code_8039CA84 = D_hd_code_803156C0;
        return;
    }
    sp2F = 0;
    while ((D_hd_code_8039CA78 < D_hd_code_8039CA70[0] - 2) && !sp2F) {
        if (sp28 >= D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk12 && sp28 < D_hd_code_8039CA68[0][D_hd_code_8039CA78+1].unk12) {
            sp2F = 1;
        } else {
            D_hd_code_8039CA78 += 1;
        }
    }
    sp2F = 0;
    sp24 = D_hd_code_8039CA78 + 1;
    while ((sp24 < (D_hd_code_8039CA70[0] - 2)) && (sp2F == 0)) {
        if (sp28 <= D_hd_code_8039CA68[0][sp24].unk12) {
            sp2F = 1;
        } else {
            sp24 += 1;
        }
    }
    sp20 = D_hd_code_8039CA68[0][sp24].unk12 - D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk12;
    if (sp24 >= (D_hd_code_8039CA70[0] - 2)) {
        sp1C = D_hd_code_8039CA68[0][sp24].unk12 - D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk12;
    } else {
        sp1C = sp28 - D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk12;
    }
    sp18 = sp1C / (f32) sp20;
    *arg0 = (D_hd_code_8039CA68[0][sp24].unk0 - D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk0) * sp18 + D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk0;
    *arg1 = (D_hd_code_8039CA68[0][sp24].unk4 - D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk4) * sp18 + D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk4;
    *arg2 = (D_hd_code_8039CA68[0][sp24].unk8 - D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk8) * sp18 + D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk8;
    *arg3 = func_hd_code_80295924(D_hd_code_8039CA68[0][D_hd_code_8039CA78].unkC, D_hd_code_8039CA68[0][sp24].unkC, sp18);
    *arg4 = func_hd_code_80295924(D_hd_code_8039CA68[0][D_hd_code_8039CA78].unkE, D_hd_code_8039CA68[0][sp24].unkE, sp18);
    *arg5 = func_hd_code_80295924(D_hd_code_8039CA68[0][D_hd_code_8039CA78].unk10, D_hd_code_8039CA68[0][sp24].unk10, sp18);
}
...
void func_hd_code_80295A20(u32 arg0) {
  ...
  if (D_hd_code_8039CA88 >= arg0) {
    if (D_hd_code_8039CA8C == 0) {
      D_hd_code_8039CA7D = 1;
    } else {
      D_hd_code_8039CA7D = 0;
    }

    spC = (u8*)&D_hd_code_8039CA68[0][0];
    sp8 = (u8*)D_hd_code_8039CA68[1];
    for(sp4 = 0; sp4 < 0x10000; sp4++) {
      spC[sp4] = sp8[sp4];
    }

    D_hd_code_8039CA7C = D_hd_code_803643D4;
    D_hd_code_8039CA70[0] = D_hd_code_8039CA70[1];
    D_hd_code_8039CA88 = arg0;
  }
}
...
// Override the loaded-world-cell list (D_hd_code_803C30A8) when the player at
  ...
  for(sp2C = 0; sp2C < 1; sp2C++) {
    if (D_hd_code_802FF150[sp2C].unk28 == arg0
      ...
      while (D_hd_code_802FF150[sp2C].unk20[sp28] != -1) {
        D_hd_code_803C30A8[sp28] = D_hd_code_802FF150[sp2C].unk20[sp28];
        sp28++;
      }
      D_hd_code_803C30A8[sp28] = 0xFFFF;
    }
  }
}
