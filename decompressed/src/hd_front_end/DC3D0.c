...
// <data>
struct LevelData D_hd_front_end_8020D810[60] = {
    { 0x64010000, "SIMIAN ACRES", (s32) D_hd_code_80303700, 0x00000000, 0.0f, 0.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x1C, 0x13, 0x03, 0x37, 0x32, 0xFF, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "ANGEL CITY", (s32) D_hd_code_8030370C, 0x00000000, -20.0f, -120.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "OUTLAND FARM", (s32) D_hd_code_80303720, 0x00000000, 20.0f, 60.0f, { 0x25, 0x1B, 0xFF, 0x00 }, { 0x05, 0x0D, 0x09, 0xFF, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "BLACKRIDGE WORKS", (s32) D_hd_code_80303734, 0x00000000, -20.0f, -20.0f, { 0x14, 0x06, 0xFF, 0x00 }, { 0x1D, 0x35, 0x0F, 0x0A, 0xFF, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "GLORY CROSSING", (s32) D_hd_code_80303748, 0x00000000, 70.0f, 180.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SHUTTLE GULLY", (s32) D_hd_code_8030375C, 0x00000000, 50.0f, 20.0f, { 0x29, 0xFF, 0x00, 0x00 }, { 0x04, 0x21, 0x02, 0xFF, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SALVAGE WHARF", (s32) D_hd_code_8030376C, 0x00000000, -30.0f, -10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SKYFALL", (s32) D_hd_code_8030377C, 0x00000000, 40.0f, 20.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x05, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "TWILIGHT FOUNDRY", (s32) D_hd_code_80303794, 0x00000000, 10.0f, 30.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "CRYSTAL RIFT", (s32) D_hd_code_803037A8, 0x00000000, 20.0f, 120.0f, { 0x33, 0x1F, 0xFF, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "ARGENT TOWERS", (s32) D_hd_code_803037B8, 0x00000000, -20.0f, 20.0f, { 0x15, 0x22, 0xFF, 0x00 }, { 0x0D, 0x11, 0x10, 0x03, 0xFF, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SKERRIES", (s32) D_hd_code_803037CC, 0x00000000, 70.0f, 0.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "DIAMOND SANDS", (s32) D_hd_code_803037D8, 0x00000000, -70.0f, 110.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "EBONY COAST", (s32) D_hd_code_803037EC, 0x00000000, -20.0f, 60.0f, { 0x20, 0xFF, 0x00, 0x00 }, { 0x1A, 0x11, 0x02, 0xFF, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "OYSTER HARBOR", (s32) D_hd_code_803037FC, 0x00000000, -70.0f, -110.0f, { 0x17, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "CARRICK POINT", (s32) D_hd_code_8030380C, 0x00000000, 20.0f, -20.0f, { 0x19, 0x1E, 0xFF, 0x00 }, { 0x21, 0x12, 0x10, 0x03, 0xFF, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "HAVOC DISTRICT", (s32) D_hd_code_8030381C, 0x00000000, 20.0f, 20.0f, { 0x16, 0x08, 0xFF, 0x00 }, { 0x07, 0x02, 0x0F, 0x0A, 0xFF, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "IRONSTONE MINE", (s32) D_hd_code_8030382C, 0x00000000, -50.0f, 20.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x0A, 0x0C, 0x0D, 0x3A, 0xFF, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "BEETON TRACKS", (s32) D_hd_code_80303844, 0x00000000, 20.0f, -60.0f, { 0x30, 0xFF, 0x00, 0x00 }, { 0x1D, 0x0F, 0x21, 0x39, 0xFF, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x00000000, "J-BOMB", (s32) D_hd_code_80303854, 0x00000000, 10.0f, 10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x10, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "JADE PLATEAU", (s32) D_hd_code_80303864, 0x00000000, -10.0f, -30.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MARINE QUARTER", (s32) D_hd_code_80303874, 0x00000000, -30.0f, 10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "COOTER CREEK", (s32) D_hd_code_80303884, 0x00000000, 30.0f, 10.0f, { 0x0B, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "GIBBON'S GATE", (s32) D_hd_code_80303890, 0x00000000, -50.0f, 180.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "BABOON CATACOMB", (s32) D_hd_code_803038A0, 0x00000000, 30.0f, -150.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x25, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SLEEK STREETS", (s32) D_hd_code_803038B0, 0x00000000, 10.0f, -30.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "OBSIDIAN MILE", (s32) D_hd_code_803038C0, 0x00000000, -20.0f, 120.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "CORVINE BLUFF", (s32) D_hd_code_803038D0, 0x00000000, 10.0f, 50.0f, { 0x38, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x28010000, "SIDESWIPE", (s32) D_hd_code_803038E0, 0x00000000, 10.0f, -10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x0F, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "ECHO MARCHES", (s32) D_hd_code_803038F8, 0x00000000, -20.0f, -60.0f, { 0x2A, 0x27, 0xFF, 0x00 }, { 0x01, 0x3A, 0x12, 0xFF, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "KIPLING PLANT", (s32) D_hd_code_80303904, 0x00000000, 30.0f, -10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "FALCHION FIELD", (s32) D_hd_code_80303918, 0x00000000, 45.0f, 100.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MORGAN HALL", (s32) D_hd_code_80303930, 0x00000000, -10.0f, 50.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "TEMPEST CITY", (s32) D_hd_code_8030393C, 0x00000000, 50.0f, -20.0f, { 0x23, 0xFF, 0x00, 0x00 }, { 0x12, 0x05, 0x04, 0xFF, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "ORION PLAZA", (s32) D_hd_code_80303950, 0x00000000, -10.0f, 30.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "GLANDER'S RANCH", (s32) D_hd_code_80303960, 0x00000000, 50.0f, -70.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "DAGGER PASS", (s32) D_hd_code_80303974, 0x00000000, -20.0f, 180.0f, { 0x34, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "GEODE SQUARE", (s32) D_hd_code_80303980, 0x00000000, 50.0f, 180.0f, { 0x3B, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SHUTTLE ISLAND", (s32) D_hd_code_80303990, 0x00000000, 0.0f, -140.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x28, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MICA PARK", (s32) D_hd_code_803039A8, 0x00000000, -40.0f, -80.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MOON", (s32) D_hd_code_803039B4, 0x00000000, 10.0f, -140.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x2B, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "COBALT QUARRY", (s32) D_hd_code_803039BC, 0x00000000, 50.0f, 70.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MORAINE CHASE", (s32) D_hd_code_803039CC, 0x00000000, -10.0f, -80.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MERCURY", (s32) D_hd_code_803039E0, 0x00000000, 20.0f, -140.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x2C, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "VENUS", (s32) D_hd_code_803039F0, 0x00000000, 30.0f, -140.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x2D, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MARS", (s32) D_hd_code_803039FC, 0x00000000, 40.0f, -140.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x2E, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "NEPTUNE", (s32) D_hd_code_80303A04, 0x00000000, 50.0f, -140.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x00000000, "CMO INTRO", (s32) D_hd_code_80303A14, 0x00000000, 70.0f, 0.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SILVER JUNCTION", (s32) D_hd_code_80303A24, 0x00000000, 10.0f, -80.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "END SEQUENCE", (s32) D_hd_code_80303A34, 0x00000000, 0.0f, -10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SHUTTLE CLEAR", (s32) D_hd_code_80303A48, 0x00000000, 0.0f, -15.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x26, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "DARK HEARTLAND", (s32) D_hd_code_80303A58, 0x00000000, 0.0f, 90.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "MAGMA PEAK", (s32) D_hd_code_80303A68, 0x00000000, 0.0f, -150.0f, { 0x18, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x0A000000, "THUNDERFIST", (s32) D_hd_code_80303A74, 0x00000000, -40.0f, -20.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x3A, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "SALINE WATCH", (s32) D_hd_code_80303A8C, 0x00000000, 0.0f, 150.0f, { 0x24, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "BACKLASH", (s32) D_hd_code_80303A98, 0x00000000, -10.0f, 10.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x0A, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "BISON RIDGE", (s32) D_hd_code_80303AB0, 0x00000000, 0.0f, 40.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "EMBER HAMLET", (s32) D_hd_code_80303AC0, 0x00000000, 20.0f, -120.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "CROMLECH COURT", (s32) D_hd_code_80303AD4, 0x00000000, -50.0f, -20.0f, { 0xFF, 0x00, 0x00, 0x00 }, { 0x0E, 0x11, 0x1D, 0xFF, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f },
    { 0x64010000, "LIZARD ISLAND", (s32) D_hd_code_80303AE8, 0x00000000, 30.0f, 150.0f, { 0x36, 0xFF, 0x00, 0x00 }, { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0.0f, 0.0f, 0.0f }
};
u16 D_hd_front_end_8020E350[38] = {
  0x0000,
  0x0000,
  0x0571,
  0x0570,
...
Lights1 D_hd_front_end_8020E3A8[2] = {
...
Gfx* func_hd_front_end_801FA180(Gfx* arg0, struct Model1* arg1, f32 arg2, s8* arg3) {
    ...
    for (sp64 = 0; sp64 < LEVEL_MAX; sp64++) {
