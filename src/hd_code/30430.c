...
// <bss>
u16 D_hd_code_8036C770; // message window id hidden during the fade, restored after fade-in; proposed name: fadeSavedWindow
f32 D_hd_code_8036C774; // fade-out alpha step per frame; proposed name: fadeOutSpeed
u64 D_hd_code_8036C778; // game state to enter once the fade-out completes (0 = not fading out); proposed name: fadeTargetState
s32 D_hd_code_8036C780; // frame the fade started; proposed name: fadeStartFrame
u8 D_hd_code_8036C784; // current fade overlay alpha; proposed name: fadeAlpha
// </bss>
...
Gfx* func_hd_code_80274BF0(void* arg0, Gfx* gfx) {
    ...
    if ((D_hd_code_8036C778 != 0)) {
        ...
        D_hd_code_8036C784 = MAX(0.0f, 255.0f - ((D_hd_code_803156C4 - D_hd_code_8036C780) * D_hd_code_802FA930));
        if (D_hd_code_8036C784 == 0) {
            func_hd_code_8026AF6C(D_hd_code_8036C770);
            D_hd_code_8036C770 = 0;
        }
    }
    if (D_hd_code_8036C784 != 0) {
        gDPPipeSync(entry++);
        ...
        gDPSetPrimColor(entry++, 0, 0, 0, 0, 0, D_hd_code_8036C784);
...
s32 areWeFading(void) {
  return D_hd_code_8036C778 != 0 ? 1 : 0;
}
...
s32 func_hd_code_802753F8(void) {
  return D_hd_code_8036C770 != 0 ? 1 : 0;
}
