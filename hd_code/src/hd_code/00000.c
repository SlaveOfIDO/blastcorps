...
s32 func_hd_code_80258B78(void**, s32*);                        /* extern */
void func_hd_code_80259450();                                  /* extern */
s32 func_hd_code_80259C24(Gfx**, struct Model1*);                        /* extern */
void func_hd_code_80259CCC(struct Model1*, const char*, s32*, s32, s32, s32, s32, s32, s32, s32, s32, s32, s32, s32); /* extern */
...
s32 func_hd_code_8025BD98();                          /* extern */
...
void func_hd_code_80258544(struct Texture*, s32, s32, s32, f32, s32, s32, s32); /* extern */
...
s32 func_hd_code_802D4E10(s32);                     /* extern */
...
extern u8 playerNumber; // safe name: playerNumber
...
/*
extern s32* D_80364AF0;
extern s32* D_80364AF8;
*/
...
extern const char D_hd_code_80308358[];
extern s32 D_hd_code_80308384;
extern s32 D_hd_code_80308390;
extern const char D_hd_code_80308398[];
extern s32 D_hd_code_803083C4;
extern s32 D_hd_code_803083E4;
extern const char D_hd_code_803083EC[];
extern const char D_hd_code_80308418[];
extern const char D_hd_code_80308440[];
    ...
    if (D_hd_code_80364A90 & 0x104) {
        ...
        if ((D_80370C28 & 4) && !(D_80370C28 & 8)) {
            if (((f64) D_hd_code_802E8BE0 < 1.5) && (D_hd_code_80364A90 == 4)) {
                sp5B = 2;
                if (!(D_80370C2A & 4)) {
                    func_hd_code_80260650(D_80367738, 0xDCU, NULL);
                }
        ...
        if (sp5B == 0) {
            if ((D_80370C28 & 8) && !(D_80370C28 & 4)) {
                if (((f64) D_hd_code_802E8BE0 > 1.0) && D_hd_code_80364A90 == 4 && (D_80364A7C == 0)) {
                    sp5B = 1;
                    if (!(D_80370C2A & 8)) {
                        func_hd_code_80260650(D_80367738, 0xDDU, NULL);
                    }
        ...
        case 3:
            if ((D_hd_code_803643DB != 0) || (D_80364AC1 != 0)) {
                ...
                D_80364A98 = 0x100;
                D_hd_code_80364A78 = 0;
                func_hd_code_80260650(D_80367738, 0xDFU, NULL);
            }
            break;
        case 4:
            D_80364A7C = 1;
        ...
        switch(D_hd_code_80364A90) {
            case 0x100000000000:
                if((levelno != 0x2F) && (levelno != 0x31) && ((levelno != 0x26) || (D_80364A88 == 0x4000))) {
                    func_hd_code_80260650(D_80367738, 0xDEU, NULL);
                    D_80364A98 = 0x4000;
                }
                break;
            case 0x40:
...
block_275:
    ...
    if (D_80364AA8 != 1) {
        ...
        if (((D_80364AF0[playerNumber].unk18[levelno] > 0 && D_80364AF0[playerNumber].unk18[levelno] < 6)?1:0) == 0) {
            ...
            D_803643DA = 1;
            func_hd_code_80260650(D_80367738, 0x2BU, NULL);
    ...
    if ((D_hd_code_80364A90 == 0x2000000000000000)) {
        if ((D_80370C28 & 0x10) && !(D_80370C2A & 0x10)) {
            if ((D_8036BB18 < 0x6B) && (D_8036BB1C != 8) && (D_8036BB1C != 1)) {
                ...
                func_hd_code_80260650(D_80367738, 0x1DU, NULL);
            } else {
                func_hd_code_80260650(D_80367738, 0xD0U, NULL);
            }
        }
    ...
    if ((((D_80370C28 & 0x1000) && !(D_80370C2A & 0x1000)) ||
        ...
        switch(D_hd_code_80364A90) {
            ...
            case 0x1:
                if (levelno != 0x32 || D_80364A88 == 0x4000) {
                    D_80364A98 = 0x2000;
                    func_hd_code_80260650(D_80367738, 0x1EU, NULL);
                }
                break;
            case 0x400:
            case 0x40:
    ...
    if (D_80364A6F != D_803153F0) {
        ...
        case 1:                                     /* switch 1 */
            ...
            case 0:                                 /* switch 2 */
                ...
                /* fallthrough */
            case 2:                                 /* switch 2 */
                func_hd_code_802608C8(D_803156E8);
                break;
            }
            break;
        case 2:                                     /* switch 1 */
            ...
            case 0:                                 /* switch 3 */
                ...
                /* fallthrough */
            case 1:                                 /* switch 3 */
                func_hd_code_80260650(D_80367738, 0x26U, &D_803156E8);
                break;
            }
            break;
        case 0:                                     /* switch 1 */
            ...
            if (D_803153F0 == 2) {
                func_hd_code_80260650(D_80367738, 0x68U, NULL);
            }
            break;
        }
    }
...
void func_hd_code_8024AE2C(void) {
    ...
    if ((D_803649ED != 0) && (D_803649ED != 0xFF)) {
        ...
        if (func_hd_code_80260634(D_803156F0) == 0) {
            func_hd_code_80260650(D_80367738, 0x2B, &D_803156F0);
        }
    }
}
...
void func_hd_code_8024B188(void) {
    ...
    if (((sp27 == 0) || ((sp27 != 2) && (sp26 == 0))) && (func_hd_code_80260634(D_803156EC) == 0)) {
        func_hd_code_80260650(D_80367738, 0x2BU, &D_803156EC);
    }
}
