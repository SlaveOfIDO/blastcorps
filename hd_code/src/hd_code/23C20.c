...
void func_hd_code_80268664(s32 arg0) {
  ...
  D_8036B8B0 = 0;
  D_8036B8C0 = 0;
  while(((s32) D_8036B8C0 < 3) && (D_8036B8B0 == 0)) {
...
void func_hd_code_802688C4(s32 arg0) {
    ...
    if (D_8036B8B0 != 0) {
        ...
        if ((D_hd_code_803643D7 == 0) && (D_hd_code_803643D6 == 0) && (areWeFading() == 0)) {
            D_8036B908 += (f32)D_hd_code_802F3C24[D_8036B8C0].unk8 * ((D_hd_code_802F3C48[sp4C[2]].unkC - D_hd_code_802F3C48[sp4C[1]].unkC) * sp44 + D_hd_code_802F3C48[sp4C[1]].unkC);
        }
        if (D_8036B908 >= 0x3E8) {
            D_8036B908 = 0;
            D_8036B90C += 1;
...
s32 func_hd_code_80268EE8(s32 arg0) {
  ...
  while(sp4 < 3) {
    if (D_hd_code_802F41E8[sp4].unk0 == arg0) {
      D_803FCD75 = D_hd_code_802F41E8[sp4].unk5;
      return 1;
    }
    sp4++;
  }
...
s32 func_hd_code_8026A828(s32 arg0, s32 arg1) {
  ...
  sp4 = (D_8036B968 & 0x7FFFFFFF) / 2.1474836e9f;
  sp4 = (arg1 - arg0) * sp4 + arg0;
  return sp4 + 0.5;
}

void func_hd_code_8026A8BC(void) {
  D_8036B968 = (s32)osGetCount();
}
...
s32 func_hd_code_8026A8E0(s32 arg0, s32 arg1) {
  ...
  sp4 = (D_8036B96C & 0x7FFFFFFF) / 2.1474836e9f;
  sp4 = (arg1 - arg0) * sp4 + arg0;
  return sp4 + 0.5;
}
