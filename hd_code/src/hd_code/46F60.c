...
void func_hd_code_8028B734(s8* arg0, s8* arg1, u8 arg2) {
  ...
  *arg1 = (s8) sp32;
  ...
  if ((u8) D_80370C75 == 1) {
    ...
    if ((ABS(sp2C)) <= (ABS(D_80370C72 * 0x10))) {
      D_80370C75 = 0;
    }
    sp2E = 0x200;
  } else {
    if (*arg1 >= 0xB) {
      sp2E = func_hd_code_8028BA1C(sp30, sp34, &D_80370C74, arg2);
    }
    if ((D_80370C74 != 0) && (D_hd_code_8036443C < 0x28)) {
      D_80370C76 = sp34;
      D_80370C75 = 1;
    }
    else if ((u8) D_803ED40A != 0) {
...
u16 func_hd_code_8028BA1C(s16 arg0, s16 arg1, s8* arg2, u8 arg3) {
  ...
  if ((ABS(spE)) <= (ABS(D_80370C72 * 0x10))) {
    D_803ED40A = 1;
  }
...
void func_hd_code_8028BF34(u16* arg0, s8 arg1, s8 arg2, u8 arg3) {
  ...
  if (!(*arg0 & 0x300) && (sp28 & 1)) {
    *arg0 |= func_hd_code_8028BA1C(sp2A, sp2E, &D_80370C74, arg3);
  }
