...
void __scMain(void* arg0) {
    ...
    while(1) {
        ...
        case RDP_DONE_MSG:
            ...
            break;
        case 5:
            osSendMesg(D_8036BF78.mq, D_8036BF78.msg, 1);
            break;
        case PRE_NMI_MSG:
            for (sp2C = sp30->clientList; sp2C != NULL; sp2C = sp2C->next) {
                osSendMesg(sp2C->msgQ, (void* )0x29D, 0);
...
void func_hd_code_80271358(OSSched* arg0) {
  ...
  if ((arg0->audioListHead != NULL) && !(arg0->unk803156C4 & 1)) {
    osSetTimer(&D_8036BF78, 0x445C0, 0, (OSMesgQueue* ) arg0->audioListHead->msgQ->fullqueue, (void* )5);
  }
...
void func_hd_code_802715DC(OSSched* arg0) {
    ...
    if (sp2C->flags & 0x40) {
        sp20 = osGetTime();
        D_8036BF24 = (sp20 - arg0->unk803156D0) / 0x1E91;
...
void func_hd_code_80271904(OSSched* arg0) {
  ...
  sp24->flags |= 8;
  if ((arg0->unk803156C4 != D_8036BF14) || (D_hd_code_80364A90 & 0xC9FD0FE79BFF80B0)) {
    D_8036BF1C = NULL;
  ...
  sp18 = osGetTime();
  D_8036BF20 = (sp18 - arg0->unk803156C8) / 0x1E91;
...
void func_hd_code_80271CE4(OSSched* arg0, s32 arg1) {
  ...
  if (arg1 == NULL) {
    ...
    if ((u8) D_hd_code_802FA270 != 0) {
      ...
      D_8036BF2C = (sp18 - D_8036BF38) / 0x1E91;
...
s32 func_hd_code_80271F48(OSMesgQueue* arg0, OSMesg arg1, s32 arg2) {
  ...
  sp28 = D_8036BF38 + 0x5F852 - osGetTime();
  sp20 = osGetTime();
  sp1C = 0;
