...
void func_hd_code_80275478(struct Model1* arg0, Gfx** arg1, s32 arg2) {
    ...
    D_8036C7CC = 0;
    sp54 = D_8036C790;
    if ((D_8036EB98 == 0) && (sp50 == 0) && (D_hd_code_80364AA8 == 1) && (D_hd_code_802E8BD0 == 0)) {
    ...
    if ((D_8036C790 != NULL) && ((func_hd_code_802768A8() == 0) || ((u8) arg2 != 0)) && (D_8036C794 == NULL)) {
        for(sp76 = 0; sp76 < 4; sp76++) {
            func_hd_code_8027690C(arg0, D_8036C790->x, D_8036C790->y, D_8036C790->z, &sp6A, &sp68, 0, 0, 0, 1.0f);
            D_8036C790++;
            if (sp6A < sp62) {
                sp62 = sp6A;
            }
    ...
    if (D_8036C794 != NULL) {
        func_hd_code_802BD10C(D_8036C798);
        if ((D_8036C7C8 >= 0x5DD) || (D_hd_code_803643DB == 0)) {
            sp5A = 0xFF;
            sp5B = 0;
        } else if (D_8036C7C8 < 0x1F4) {
            sp5B = 0xFF;
            sp5A = 0;
        } else {
            sp58 = (((D_8036C7C8 - 0x1F4) / 1000.0f) * 511.0f);
            if (sp58 < 0x100) {
                sp5A = sp58,
                sp5B = 0xFF;
            } else {
...
void func_hd_code_80276E50(Gfx** arg0, struct Model1* arg1, u8 arg2, s32 arg3, s32 arg4, s32 arg5) {
    ...
    if ((sp10E < 0x1E) || (sp10E >= 0x123) || (sp10C < 0x19) || (sp10C >= 0xD8)) {
        ...
        D_8036C7D0[arg2][0].v.ob[0] = -0xF;
        D_8036C7D0[arg2][0].v.ob[1] = -0xF;
        D_8036C7D0[arg2][0].v.ob[2] = -0xA;
        D_8036C7D0[arg2][0].v.tc[0] = 0;
        D_8036C7D0[arg2][0].v.tc[1] = 0;

        D_8036C7D0[arg2][1].v.ob[0] = 0xF;
        D_8036C7D0[arg2][1].v.ob[1] = -0xF;
        D_8036C7D0[arg2][1].v.ob[2] = -0xA;
        D_8036C7D0[arg2][1].v.tc[0] = 0x3E0;
        D_8036C7D0[arg2][1].v.tc[1] = 0;

        D_8036C7D0[arg2][2].v.ob[0] = 0xF;
        D_8036C7D0[arg2][2].v.ob[1] = 0xF;
        D_8036C7D0[arg2][2].v.ob[2] = -0xA;
        D_8036C7D0[arg2][2].v.tc[0] = 0x3E0;
        D_8036C7D0[arg2][2].v.tc[1] = 0x3E0;

        D_8036C7D0[arg2][3].v.ob[0] = -0xF;
        D_8036C7D0[arg2][3].v.ob[1] = 0xF;
        D_8036C7D0[arg2][3].v.ob[2] = -0xA;
        ...
        gSPMatrix(entry++, &D_2000000.mtx1, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_PROJECTION);
        gSPMatrix(entry++, &D_8036C850[arg2], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
        gDPPipeSync(entry++);
        gDPSetCycleType(entry++, G_CYC_1CYCLE);
        gDPSetRenderMode(entry++, G_RM_XLU_SURF, G_RM_XLU_SURF2);
        gSPClearGeometryMode(entry++, G_ZBUFFER | G_TEXTURE_ENABLE | G_SHADE | G_CULL_BOTH | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR | G_LOD | G_SHADING_SMOOTH | 0xFFE0CDF8);
        ...
        gDPLoadTextureBlock(entry++, OS_PHYSICAL_TO_K0(D_hd_code_802FA940), G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
        gSPVertex(entry++, OS_PHYSICAL_TO_K0(D_8036C7D0[arg2]), 4, 0);
...
void func_hd_code_802775C0() {
  ...
  D_8036CB48[0] = D_hd_code_80358070;
  D_hd_code_80358070 += 0xC80;

  D_8036CB48[1] = D_hd_code_80358070;
  D_hd_code_80358070 += 0xC80;
