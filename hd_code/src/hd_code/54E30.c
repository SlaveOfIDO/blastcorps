...
extern u64 D_803A6AF0;
extern u64 D_803A6AF8;
...
void func_hd_code_802995F0(s32 arg0) {
    ...
    case 5:
        ...
        D_803A6B01 = 0x37;
        D_803A6B00 = 0x37;
        if ((players[playerNumber].unk18[D_803A6B00] > 0 && players[playerNumber].unk18[D_803A6B00] < 6)?1:0) {
            D_803A6AF0 = 0x80;
            D_803A6AF8 = 0x80;
        } else {
            D_803A6AF0 = 0x2000;
...
void func_hd_code_80299E10(s32 arg0) {
  ...
  if (arg0 != 0) {
    ...
    D_hd_code_80364A98 = D_803A6AF0;
    levelno = D_803A6B00;
  } else {
    D_hd_code_80364A98 = D_803A6AF8;
    levelno = D_803A6B01;
  }
